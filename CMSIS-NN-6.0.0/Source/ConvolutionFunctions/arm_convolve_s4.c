...
void printArray(const char *label, int8_t *arr, int size) {
    printf("%s:\n", label);
                                    ...
                                    int8_t *output_data)
{
    ...
    printf("Entered Covolution\n");
    for (int i1 = 0; i1<288; i1++){
        printf("%d ", output_data[i1]);
        }
    printf("\n\n");
    ...
    for (i_batch = 0; i_batch < input_batches; i_batch++)
    {
        ...
        printArray("output_data after processing batch", out, output_x * output_y * output_ch);

        printf("\nFinished MatMul %d times.\n", counter);
    ...
    printArray("Final output_data", output_data, output_x * output_y * output_ch);
